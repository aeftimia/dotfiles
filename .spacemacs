...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; tabs
   dotspacemacs-configuration-layers '(tabs :variables tabs-highlight-current-tab 'left)))
